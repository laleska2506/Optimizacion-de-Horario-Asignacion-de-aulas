...
def mostrar_horario_matriz(x, dias, franjas_por_dia, cursos, salones):
...
if LpStatus[prob.status] == 'Optimal':
    ...
    horario_df = mostrar_horario_matriz(x, dias, franjas_por_dia, cursos, salones)
    print(tabulate(horario_df, headers='keys', tablefmt='grid', showindex=True))
